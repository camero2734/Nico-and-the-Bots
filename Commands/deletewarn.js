module.exports = {
    execute: async function (msg) {
        try {
            ...
            if (chosenRow === null) return msg.channel.embed("Invalid input");

            //DELETE
            await sql.run(`DELETE FROM warn WHERE userid="${chosenRow.userid}" AND date="${chosenRow.date}"`);
            
            msg.channel.embed("Deleted warning!")
        } catch (e) {
            console.log(e)
        }
    },
