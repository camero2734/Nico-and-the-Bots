...
type ApplicationDataType = ApplicationCommandOptionData &
...
type AsArray<T extends DeepReadonly<CommandOptions[number]>> = [
	T["name"],
	T["type"],
	T["required"],
	T["choices"],
...
type ChoicesUnion<
	T extends DeepReadonly<ApplicationCommandOptionChoiceData[]>,
	P,
...
export function extractOptsFromInteraction(
