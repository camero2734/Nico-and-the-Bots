...
const wiki = WikiJS({
  headers: {
    "User-Agent": "Nico-Discord-Bot (https://github.com/camero2734/Nico-and-the-Bots; discordclique@gmail.com) wiki.js",
  },
});
...
command.setHandler(async (ctx) => {
  ...
  const embed = new EmbedBuilder()
    .setAuthor({ name: title, icon_url: wikipediaLogo, url: url })
    .setColor(0xaaacae)
