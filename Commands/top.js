...
module.exports = {
    execute: async function (msg) {
        try {
            ...
            //Some initialization 
            let economies = await connection.getRepository(Economy).createQueryBuilder("e").orderBy("e.monthlyScore", "DESC").limit(10).offset(10 * page - 10).getMany();
