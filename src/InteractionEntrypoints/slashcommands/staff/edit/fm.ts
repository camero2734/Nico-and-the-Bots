...
const command = new SlashCommand({
	...
	options: [
		...
		},
		{
			...
			choices: [{ name: "Migrate", value: "MIGRATE_USERNAME" }],
		},
	],
});
...
const genMigrateModalId = command.addInteractionListener(
	"fmMigrateModal",
	["userId"],
	async (ctx, args) => {
