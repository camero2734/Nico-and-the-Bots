...
export const MessageTools = {
	...
	allocateButtonsIntoRows(
		...
		const maxButtonsPerRow =
			options?.maxButtonsPerRow ?? constants.ACTION_ROW_MAX_ITEMS;

		if (buttons.length > maxButtonsPerRow * constants.MAX_ACTION_ROWS)
